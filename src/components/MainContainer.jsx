    ...
    <div className='w-full h-auto flex flex-col items-center justify-center'>
      ...
      <section className='w-full my-6'> 
        <div className='w-full flex items-center justify-between'>
          ...
          before:absolute before:-bottom-2 before:rounded-lg before:w-32 before:h-1 before:left-0 before:bg-gradient-to-r from-orange-400 to-orange-600 transition-all ease-in-out duration-100'>
