                        ...
                        />
                        {
                            isMenu && (
                                <motion.div
                                    ...
                                    exit={{ opacity: 0, scale: 0.6 }} className='w-40 bg-gray-50 shadow-xl rounded-lg flex flex-col absolute top-10 right-0'>
                                    {
                                        user && user.email === 'dj.nurc00l@gmail.com' && (
                                            <Link to={'/createItem'}>
                                                <p
                    ...
                    />
                    {
                        isMenu && (
                            <motion.div
                                ...
                                <p
                                    className='m-2 p-2 rounded-md shadow-md flex items-center justify-center bg-gray-200 gap-3 cursor-pointer hover:bg-gray-300 transiition-all duration-100 ease-in-out text-textColor text-base'
                                    onClick={logout}>
                                    Logout <MdLogout /></p>
                            </motion.div>
                        )
